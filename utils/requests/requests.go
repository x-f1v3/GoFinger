...
// 限制跳转次数
func (req *Request) SetRedirect(n int) {
	req.Client.CheckRedirect = func(redirectedRequest *http.Request, previousRequests []*http.Request) error {
		if len(previousRequests) >= n {
